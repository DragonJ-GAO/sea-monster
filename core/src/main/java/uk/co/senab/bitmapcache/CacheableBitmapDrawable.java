...
public class CacheableBitmapDrawable extends BitmapDrawable {
    ...
    /**
     * @return true - if the bitmap is currently being displayed by a {@link uk.co.senab.bitmapcache.CacheableImageView}.
     */
     ...
     * @see uk.co.senab.bitmapcache.Constants#UNUSED_DRAWABLE_RECYCLE_DELAY_MS
     */
    ...
    /**
     * Runnable which run a {@link uk.co.senab.bitmapcache.CacheableBitmapDrawable#checkState(boolean) checkState(false)}
     * call.
     *
     * @author chrisbanes
     */
